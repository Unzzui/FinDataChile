    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs defaultValue="dashboard" className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span>Banco de Chile - 3 Años</span>
                      <Badge variant="secondary">127 ventas</Badge>
                    </div>
                    <div className="flex justify-between items-center">
                      <span>Codelco - 2024</span>
                      <Badge variant="secondary">89 ventas</Badge>
                    </div>
                    <div className="flex justify-between items-center">
                      <span>Falabella - 2024</span>
                      <Badge variant="secondary">67 ventas</Badge>
                    </div>
                    <div className="flex justify-between items-center">
                      <span>Banco Santander - 2024</span>
                      <Badge variant="secondary">54 ventas</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <TabsContent value="payment-simulator" className="space-y-4">
            <TestPaymentSimulator />
          </TabsContent>
        </Tabs>
      </div>
